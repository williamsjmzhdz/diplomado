...
public class MeansContactsServiceImpl implements MeansContactsService {
	...
	@Override
	public Boolean deleteAllMeansContactsByContactId(Integer id) { return contactoDAO.deleteAllMeansContactsByContactId(id); }

	@Override
	public Set<MeansContacts> getAllMeansContactsByContactId(Integer id) { return contactoDAO.getAllMeansContactsByContactId(id); }
}
