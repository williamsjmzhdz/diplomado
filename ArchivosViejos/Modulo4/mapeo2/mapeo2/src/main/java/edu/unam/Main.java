...
import edu.unam.hibernate.model.Table1;
...
public class Main {
    ...
    public void readRecord() {
        try {
            ...
            // se inicia una transaccion
            session.beginTransaction();
            List<Table1> result = session.createQuery("FROM Table1", Table1.class).getResultList();
            for (Table1 tabla : result) {
