...
INSERT INTO Perfil (biografia, intereses, habilidades, alumno_matricula) VALUES
("Estudiante destacado en deportes", "Deportes, lectura", "Fútbol, Atletismo", "1A"),
("Estudiante enfocada en ciencias", "Ciencia, lectura", "Química, Física", "2A"),
("Interesada en arte y cultura", "Arte, Música", "Pintura, Escultura", "3B"),
("Estudiante muy participativo", "Tecnología, ciencias", "Matemáticas, Programación", "4A"),
("Buen rendimiento académico", "Deportes, tecnología", "Fútbol, Programación", "5A"),
("Enfocado en proyectos comunitarios", "Voluntariado, ecología", "Organización, Trabajo en equipo", "6C"),
("Interesada en ciencias sociales", "Sociología, historia", "Investigación, análisis social", "7B");
